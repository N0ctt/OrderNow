namespace OrderNow
{
    partial class VerDetallesDePedido
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblDetallesPedido.Font = new Font("Segoe UI", 30F, FontStyle.Bold);
            lblDetallesPedido.ForeColor = Color.Black;
            lblDetallesPedido.Location = new Point(594, 90);
            lblDetallesPedido.Name = "lblDetallesPedido";
            lblDetallesPedido.Size = new Size(49, 54);
            ...
            lblMesa.Font = new Font("Segoe UI", 30F, FontStyle.Bold);
            lblMesa.ForeColor = Color.Black;
            lblMesa.Location = new Point(948, 91);
            lblMesa.Name = "lblMesa";
            lblMesa.Size = new Size(49, 54);
            lblMesa.TabIndex = 1;
            lblMesa.Text = "X";
            ...
            lblPrecioTotal.Font = new Font("Segoe UI", 15F, FontStyle.Bold);
            lblPrecioTotal.ForeColor = Color.Black;
            lblPrecioTotal.Location = new Point(554, 579);
            lblPrecioTotal.Name = "lblPrecioTotal";
            lblPrecioTotal.Size = new Size(90, 28);
